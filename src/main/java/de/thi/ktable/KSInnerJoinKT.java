...
public class KSInnerJoinKT {
    private static final Logger log = LoggerFactory.getLogger(KSInnerJoinKT.class);

    //0. 定义一些常量
    private static final String BOOTSTRAP_SERVERS = "localhost:19092";
    private static final String APPLICATION_ID = "ks_innerjoin_kt_app_id";
    private static final String KS_INNER_JOIN_KT_STATE_STORE = "ks_ij_kt_statestore";
    //消息结构
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        KTable<String, String> kt = builder.table(ADDRESS_INFO_TOPIC, Consumed.with(Serdes.String(), Serdes.String()).withName("address-source")
                        .withOffsetResetPolicy(AutoOffsetReset.latest()),
                Materialized.as(KS_INNER_JOIN_KT_STATE_STORE));

        ks.join(kt, (key, ksv, ktv) -> ksv + " come from " + ktv)
