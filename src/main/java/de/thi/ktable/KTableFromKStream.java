...
public class KTableFromKStream {
    private static final Logger log = LoggerFactory.getLogger(KTableFromKStream.class);

    //0. 定义一些常量
    private static final String BOOTSTRAP_SERVERS = "localhost:19092";
    private static final String APPLICATION_ID = "ktable_from_kstream_app_id";
    //消息结构
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // <alex,wang>  <alex,wu>
        builder.stream(USER_INFO_TOPIC,
                        Consumed.with(Serdes.String(), Serdes.String())
                                .withName("users-info-processor")
                                .withOffsetResetPolicy(AutoOffsetReset.latest()
                                )
                )
                .toTable(Named.as("users-info-ktable"))
                .toStream()
