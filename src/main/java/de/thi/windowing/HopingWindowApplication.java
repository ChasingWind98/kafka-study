...
public class HopingWindowApplication {
    private static final Logger log = LoggerFactory.getLogger(HopingWindowApplication.class);

    //0. 定义一些常量
    private static final String BOOTSTRAP_SERVERS = "localhost:19092";
    private static final String APPLICATION_ID = "webset_surf_app_id";
