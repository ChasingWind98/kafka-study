...
public class TumblingWindowApplication {
    private static final Logger log = LoggerFactory.getLogger(TumblingWindowApplication.class);

    //0. 定义一些常量
    private static final String BOOTSTRAP_SERVERS = "localhost:19092";
    private static final String APPLICATION_ID = "net_traffic_app_id";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        KStream<String, NetTraffic> ks0 = builder.stream(SALES_STATS_SOURCE_TOPIC, Consumed.with(Serdes.String(), JsonSerdes.NetTraffic())
                .withName("net-traffic-source-processor")
        ...
        ks0.groupBy((k, v) -> v.getRemoteAddr(), Grouped.with(Serdes.String(), JsonSerdes.NetTraffic()))
                ...
                .filter((k, v) -> v > 10)
                .toStream()
                .peek((k, v) -> log.info("IP:{} 在1分钟内访问超过 {} 次", k, v),Named.as("peek-processor"));
