...
public class StatefulLeftJoinOperation {
    ...
    private static final Logger log = LoggerFactory.getLogger(StatefulLeftJoinOperation.class);

    //0. 定义一些常量
    private static final String BOOTSTRAP_SERVERS = "localhost:19092";
    private static final String APPLICATION_ID = "stateful_left_join_app_id";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //开始LeftJoin
        nameKs1.leftJoin(addressKs1, //left 是namesKs1, right 是addressKs1  这两个KS进行left Join
                (name, address) -> name + " " + address,   //Left join时候对值进行的操作
        ...
        ).print(Printed.<String, String>toSysOut().withLabel("LeftJoin"));
