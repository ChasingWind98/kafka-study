...
public class StatefulReduceOperation {

    private static final Logger log = LoggerFactory.getLogger(StatefulReduceOperation.class);

    //0. 定义一些常量
    private static final String BOOTSTRAP_SERVERS = "localhost:19092";
    private static final String APPLICATION_ID = "stateful_reduce_app_id";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ks0.flatMap((k, v) ->
                ...
                //这里是对Value进行操作  第一个参数类型是Reducer<V> reducer
                .reduce((aggregate, newValue) -> aggregate + newValue, Named.as("reduce-processor")
                        , Materialized.as("reduce-state-store"))
                //将Ktable转换为KStream
                .toStream()
